...
class SimpleTitleBar(context: Context, attr: AttributeSet? = null) : RelativeLayout(context, attr) {
    ...
    private val topPadding by lazy { context.dp2px(40) }
    private val bottomPadding by lazy { context.dp2px(15) }
    private val startPadding = context.dp2px(20)
    private val ivSize by lazy { context.dp2px(20) }
    ...
    private val tvTitle by lazy {
        TextView(context).apply {
            ...
            //如果文字太多的话，就隐藏一部分中间的字
            maxWidth = context.getScreenWidth() / 2
